...
#define TAM 6
	...
	void myGeometryShader(point gIn vert[1], inout TriangleStream<v2f> triStream)
	{
		...
		const float4 vc[TAM] = { 
			float4(vert[0].pos.x + f, vert[0].pos.y + f, vert[0].pos.z + f, 0.0f),
			float4(vert[0].pos.x + f, vert[0].pos.y + f, vert[0].pos.z + f, 0.0f),
			float4(vert[0].pos.x + f, vert[0].pos.y + f, vert[0].pos.z + f, 0.0f),    //Top                                 
		...
		const float2 UV1[TAM] = { 
			float2(0.0f,    0.0f), float2(1.0f,    0.0f), float2(1.0f,    0.0f),         //Esta em uma ordem
