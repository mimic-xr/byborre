Shader "SuperSystems/Wireframe-Transparent"
{
    Properties
    {
		...
		_NormalBias("Normal Bias", float) = 0.0
		_CameraBias("Camera Bias", float) = 0.0
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2g vert (appdata_full v)
            {
                ...
                o.projectionSpaceVertex = UnityObjectToClipPos(v.vertex + (_NormalBias * n) + (_CameraBias * normalize(objSpaceCamPos - v.vertex)));
